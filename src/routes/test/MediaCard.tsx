...
export const MediaCard = component$(
  ({ title, rating, year, poster, width }: MediaCardProps) => {
    return (
      <div class="group w-[350px]">
        <div class="transition-scale scale-95 rounded-xl drop-shadow-lg duration-300 ease-in-out group-hover:scale-105">
          ...
          />
          <div class="badge badge-info absolute bottom-2 left-2 font-bold">
            {rating}
          </div>
          <div class="badge badge-info absolute bottom-2 right-2 font-bold">
            {year}
          </div>
        </div>
