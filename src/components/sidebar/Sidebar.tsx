...
export const Sidebar = component$(() => {
  return (
    <aside
      ...
      aria-label="Sidebar"
    >
      <div class="h-full overflow-y-auto bg-gray-50 px-3 py-4 pt-24 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span class="ml-3 inline-flex items-center justify-center rounded-full bg-gray-100 px-2 text-sm font-medium text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                Pro
              </span>
            </a>
          </li>
